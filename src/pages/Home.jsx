      ...
      <section className="px-8 pb-8">
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-8">
            ...
            <p className="text-slate-500 dark:text-slate-400 text-sm mt-2">Track air quality across the world</p>
          </div>
        ...
        <div className="max-w-7xl mx-auto">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            <div className="bg-white dark:bg-slate-800 border border-slate-200 dark:border-slate-700 rounded-2xl p-6 shadow-sm text-center">
              ...
              <p className="text-slate-500 dark:text-slate-400 text-sm mt-1">Cities Monitored</p>
            </div>
            <div className="bg-white dark:bg-slate-800 border border-slate-200 dark:border-slate-700 rounded-2xl p-6 shadow-sm text-center">
              <span className="text-3xl font-display font-bold text-slate-900 dark:text-white">
                {globalStats.countriesCovered}
              </span>
              <p className="text-slate-500 dark:text-slate-400 text-sm mt-1">Countries</p>
            </div>
            <div className="bg-white dark:bg-slate-800 border border-slate-200 dark:border-slate-700 rounded-2xl p-6 shadow-sm text-center">
              <span className="text-3xl font-display font-bold text-emerald-600 dark:text-emerald-400">
                {globalStats.avgAQI}
              </span>
              <p className="text-slate-500 dark:text-slate-400 text-sm mt-1">Global Avg AQI</p>
            </div>
          </div>
        </div>
      </section>
