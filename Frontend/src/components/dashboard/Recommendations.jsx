import { getRecommendations } from "../../data/apiClient"
...
export default function Recommendations({ lat, lng }) {
  const { data, loading } = usePolling(
    () => (lat == null || lng == null ? Promise.resolve(null) : getRecommendations({ lat, lng })),
    [lat, lng],
    REFRESH_MS
  )
